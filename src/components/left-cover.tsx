...
export function LeftCover({ data, selectedColors }: LeftCoverProps) {
  ...
  const contentWidth = leftCoverWidth - padding * 2; // 100px
  ...
  return (
    <div
      data-component="left-cover"
      className="absolute top-0 left-0"
      style={{
        width: `${leftCoverWidth}px`,
    ...
    >
      {/* Top text: "Explore the workspaces of modern creators." */}
      <p
        style={{
          width: `${leftCoverWidth - padding * 2}px`, // Fill entire width with 10px padding on each side
          fontSize: "8px",
          fontWeight: 550,
          color: textColor,
